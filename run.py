...
if __name__ == '__main__':
    ...
    parser.add_argument('--load_model', type=bool, default=True, help='status')
    ...
    parser.add_argument('--use_amp', action='store_true', help='use automatic mixed precision training', default=True)#False
